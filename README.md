...
The SemantEco core package provides reference implementations of the
SemantEco interfaces defined in the semanteco-common package, less the
query implementations, which can be found in the semanteco-query package.
